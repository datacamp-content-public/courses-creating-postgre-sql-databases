...
`@script`
THe double precision type is similar but allows up to 15 digits to the left of the decimal point. For both, the real and double precision types, the number of digits to the right of the decimal point is inexact and cannot be guaranteed to have a specific number of digits.
