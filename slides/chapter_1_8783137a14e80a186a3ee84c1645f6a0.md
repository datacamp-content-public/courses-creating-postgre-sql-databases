...
`@script`
One piece of information that we may want to track for store employees is how many sales for which the employee is responsible. This can be done by creating a "num underscore sales" column in the
